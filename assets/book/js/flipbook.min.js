...
FLIPBOOK.Book = function (h, c) {
    ...
    this.options = { onTurnPageComplete: null, flipType: "2d", shadow1opacity: 0.7, shadow2opacity: 0.7 };
    for (e in c) {
        this.options[e] = c[e];
    }
    this.pages = [];
    ...
    for (e = 0; e < b.options.pages.length; e++) {
        this.addPage(e);
        jQuery(this.pages[e].wrapper)
            .attr("title", e + 1)
            .bind(b.main.CLICK_EV, function (l) {
                var p, i, n, o, m, k;
                p = b.main.scroll.x;
                i = b.xOnMouseDown;
                n = b.main.scroll.y;
...
FLIPBOOK.Book.prototype = {
    ...
    animatePages: function (h, b) {
        ...
        if (this.flipType == "3d") {
            ...
            jQuery(h.wrapper).animate({ width: 0 }, g, d, function () {
                b.show();
                jQuery(b.wrapper).animate({ width: b.width }, e, c);
            });
        }
        setTimeout(function () {
...
(function (i, E) {
    var u = Math,
        ...
        p = (function () {
            return (
                i.cancelRequestAnimationFrame || i.webkitCancelAnimationFrame || i.webkitCancelRequestAnimationFrame || i.mozCancelRequestAnimationFrame || i.oCancelRequestAnimationFrame || i.msCancelRequestAnimationFrame || clearTimeout
            );
        })(),
        C = j ? " translateZ(0)" : "",
        v = function (G, m) {
    ...
    v.prototype = {
        ...
        _scrollbar: function (m) {
            ...
            if (!G[m + "ScrollbarWrapper"]) {
                ...
                F.style.cssText +=
                    ";pointer-events:none;" + D + "transition-property:" + D + "transform;" + D + "transition-timing-function:cubic-bezier(0.33,0.66,0.66,1);" + D + "transition-duration:0;" + D + "transform: translate(0,0)" + C;
        ...
        _start: function (K) {
            ...
            if (J.options.momentum) {
                if (J.options.useTransform) {
                    G = getComputedStyle(J.scroller, null)
                        [l].replace(/[^0-9\-.,]/g, "")
                        .split(",");
                    m = +(G[12] || G[4]);
                    L = +(G[13] || G[5]);
...
FLIPBOOK.Lightbox = function (c, d, b) {
    ...
    a.overlay = jQuery(document.createElement("div"))
        .attr("class", "flipbook-overlay")
        .css("visibility", "hidden")
        .css("z-index", "999999")
        .bind(c.START_EV, function (f) {
    ...
    if (a.options.lightboxTransparent == true) {
        ...
        a.wrapper
            ...
            .css("margin", String(a.options.lightboxMargin) + "px auto")
            .css("padding", String(a.options.lightboxPadding) + "px");
    ...
    jQuery(document.createElement("span"))
        ...
        .css("cursor", "pointer")
        .bind(a.context.START_EV, function (f) {
            a.closeLightbox();
        });
    a.resize();
...
(function init(c, b, a, e) {
    ...
    c.fn.flipBook.options = {
        ...
        pdf: "",
        pages: [],
        assets: { preloader: "images/preloader.jpg", left: "images/left.png", overlay: "images/overlay.jpg" },
        startPage: 1,
        pageWidth: 1000,
        pageHeight: 1414,
        thumbnailWidth: 100,
    ...
    d.prototype = {
        ...
        createMenu: function () {
            ...
            if (k.options.btnShare) {
                this.btnShare = c(a.createElement("span"))
                    .attr("aria-hidden", "true")
                    .appendTo(this.menu)
                    .bind(this.CLICK_EV, function () {
                        k.toggleShare();
        ...
        createShareButtons: function () {
            ...
            function f(j) {
                var i = c(a.createElement("span"))
                    .attr("aria-hidden", "true")
                    .appendTo(g.shareButtons)
                    .addClass("flipbook-shareBtn")
                    .addClass(j.icon)
                    .addClass("icon-general")
                    .addClass("skin-color")
                    .bind(g.CLICK_EV, function (k) {
                        b.open(j.url, "_self");
                    });
            }
        },
        ...
        createCurrentPage: function () {
            var f = this;
            this.currentPage = c(a.createElement("input"))
        ...
        createToc: function () {
            ...
            for (var h = 0; h < this.options.pages.length; h++) {
                ...
                var f = c(a.createElement("a"))
                    .attr("class", "flipbook-tocItem")
                    .addClass("skin-color-bg")
                    .addClass("skin-color")
                    .attr("title", String(h + 1))
                    .appendTo(this.toc)
                    .bind(g.CLICK_EV, function (l) {
        ...
        updateCurrentPage: function () {
            ...
            if (this.p && this.options.pages.length > 100 && this.options.pages.length < 4) {
        ...
        createThumbs: function () {
            ...
            for (var j = 0; j < h.options.pages.length; j++) {
                ...
                c(g.image)
                    .attr("title", j + 1)
                    .appendTo(h.thumbsContainer)
                    .bind(h.CLICK_EV, function (n) {
