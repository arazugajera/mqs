                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <?php echo form_open('Quotes/addnew/', array('id' => 'addfrm', 'class' => '', 'method' => 'POST', 'enctype' => 'multipart/form-data')); ?>
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group"> <label for="">Quote <span class="error">*</span></label>
                                                    <textarea class="form-control" rows="5" id="quote" onkeyup="preview()" name="quote" placeholder="Quote"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group"> <label for="">Color Code <span class="error">*</span></label>
                                                    <input type="text" class="form-control" maxlength="7" onkeyup="preview()" id="color_code" name="color_code" placeholder="Color Code">
                                                </div>
                                            </div>
                                        </div>
                                        <button type="submit" class="btn btn-primary waves-effect waves-light m-t-10">Add Quotes</button>
