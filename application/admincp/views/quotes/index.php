    ...
    <div class="content">
        <div class="">
            <div class="page-header-title">
                <h4 class="page-title">Quotes <a href="<?php echo site_url('Quotes/add'); ?>" class="btn btn-primary waves-effect waves-light pull-right add-btn"><i class="fa fa-plus"></i>  Add Quotes</a></h4>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <h5 class="tx-cen">Are you sure you want to <span id="new_status"></span> this Quotes?</h5>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade" id="deletemodal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <h5 class="tx-cen">Are you sure you want to delete this Quote?</h5>
    ...
    <script type="text/javascript">
        function load_transactiontable() {
            ...
            var table = jQuery('#transaction').DataTable({
                ...
                "order": [[0, "DESC"]],
                "ajax": {
                    url: "<?php echo site_url('Quotes/gettabledata'); ?>",
                    data: function (d) {
                ...
                "columns": [
                    ...
                    {"taregts": 2, 'data': 'quote'
                    },
                    {"taregts": 3, 'data': 'color_code'
                    },
                    {"taregts": 4, "searchable": false, "orderable": false, "sClass": "text-center",
                        "render": function (data, type, row) {
                            var id = btoa(row.id);
                            var out = '';
                            out += '<a title="Edit"  href="<?php echo site_url('Quotes/edit/'); ?>' + id + '"><i class="glyphicon glyphicon-edit btm-view"></i></a>&nbsp;';
        ...
        function update_status() {
            ...
            $.ajax({
                url: "<?php echo base_url() . 'Quotes/update_status' ?>",
                type: "POST",
                dataType: "json",
        ...
        function resendpass() {
            ...
            $.ajax({
                url: "<?php echo base_url() . 'Quotes/resendPass' ?>",
                type: "POST",
                dataType: "json",
        ...
        function deleterecord() {
            ...
            $.ajax({
                url: "<?php echo base_url() . 'Quotes/delete' ?>",
                type: "POST",
                dataType: "json",
